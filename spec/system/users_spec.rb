...
RSpec.describe 'Users', type: :system do
  before do
    ...
    @first_user = User.create(name: 'Tom',
                              photo: 'https://cdn3.iconfinder.com/data/icons/avatars-flat/33/man_5-512.png', bio: 'Teacher from Mexico.', posts_counter: 0)
    @second_user = User.create(name: 'Lilly',
                               photo: 'https://cdn1.iconfinder.com/data/icons/user-pictures/100/female1-512.png', bio: 'Teacher from Poland.', posts_counter: 0)
    @post1 = Post.create(author: @first_user, title: 'Hello2', text: 'This is my 2 post', comments_counter: 0,
                         likes_counter: 0)
  ...
  describe 'Index' do
    ...
    scenario 'User can click on a user and be redirected to their show page' do
      ...
      expect(current_path) == @user1_url
      visit users_path
      click_link @second_user.name
      expect(current_path) == @user2_url
    end
  end
