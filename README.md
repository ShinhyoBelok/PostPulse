...
**PostPulse** is a ruby on rails app that let you create and save posts, comments and like in a database, in a similar way of a social media app.
...
Clone the repository using [this link](https://github.com/ShinhyoBelok/PostPulse.git).
